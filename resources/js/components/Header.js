    ...
    const Header = () => (
      <nav className='navbar navbar-expand-md navbar-light navbar-laravel' style={estiloHeader}> 
          ...
          <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#hamburguer" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation"  style={estiloHeader}>
            <span className="navbar-toggler-icon" style={estiloHeader}></span>
          </button>
          <div className="collapse navbar-collapse" id="hamburguer">
            <ul className="navbar-nav mr-auto mt-2 mt-lg-0 ml-2 ">
